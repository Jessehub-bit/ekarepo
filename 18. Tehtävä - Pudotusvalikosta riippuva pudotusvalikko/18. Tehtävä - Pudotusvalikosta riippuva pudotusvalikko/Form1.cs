...
namespace _18._Tehtävä___Pudotusvalikosta_riippuva_pudotusvalikko
{
    public partial class AvainhenkilotForm : Form
    {
        ...
        DataTable yhetys = new DataTable();
        ...
        private void OppilaitosCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            yhetys = vastuuhenkilot.Select("OID =" + viite).CopyToDataTable();
            VastuuhloCB.DataSource = yhetys;
            VastuuhloCB.DisplayMember = "VNimi";
        }

        private void VastuuhloCB_TextChanged(object sender, EventArgs e)
        {
            TitteliLB.Text = yhetys.Rows[VastuuhloCB.SelectedIndex]["VTitteli"].ToString();
            OsastoLB.Text = yhetys.Rows[VastuuhloCB.SelectedIndex]["VOsasto"].ToString();
            SahkopostiLB.Text = yhetys.Rows[VastuuhloCB.SelectedIndex]["VSahkoposti"].ToString();
            PuhLB.Text = yhetys.Rows[VastuuhloCB.SelectedIndex]["VPuhelin"].ToString();
        }
    }
}
